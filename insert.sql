...
INSERT INTO zarobki VALUES (1,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),200,3500);
INSERT INTO zarobki VALUES (2,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),200,2500);
INSERT INTO zarobki VALUES (3,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,3200);
INSERT INTO zarobki VALUES (4,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,2750);
INSERT INTO zarobki VALUES (5,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),800,2450);
INSERT INTO zarobki VALUES (6,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,3040);
INSERT INTO zarobki VALUES (7,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,2700);
INSERT INTO zarobki VALUES (8,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,2600);
INSERT INTO zarobki VALUES (9,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),600,1900);
INSERT INTO zarobki VALUES (10,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,3100);
INSERT INTO zarobki VALUES (11,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,3100);
INSERT INTO zarobki VALUES (12,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,2300);
INSERT INTO zarobki VALUES (13,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),200,2100);
INSERT INTO zarobki VALUES (14,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,2200);
INSERT INTO zarobki VALUES (15,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,2950);

INSERT INTO zarobki VALUES (16,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),200,7500);
INSERT INTO zarobki VALUES (17,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),200,6500);
INSERT INTO zarobki VALUES (18,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,6500);
INSERT INTO zarobki VALUES (19,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,6750);
INSERT INTO zarobki VALUES (20,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),800,7450);
INSERT INTO zarobki VALUES (21,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,4000);
INSERT INTO zarobki VALUES (22,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,8700);
INSERT INTO zarobki VALUES (23,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,9600);
INSERT INTO zarobki VALUES (24,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),600,5900);
INSERT INTO zarobki VALUES (25,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,7200);
INSERT INTO zarobki VALUES (26,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,5100);
INSERT INTO zarobki VALUES (27,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,6300);
INSERT INTO zarobki VALUES (28,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),200,5100);
INSERT INTO zarobki VALUES (29,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,5200);
INSERT INTO zarobki VALUES (30,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),0,5950);
...
INSERT INTO dostawy VALUES (1,16,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (2,17,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (3,18,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (4,19,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (5,20,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (6,21,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (7,22,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (8,23,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (9,24,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (10,25,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (11,26,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (12,27,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (13,28,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (14,29,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
INSERT INTO dostawy VALUES (15,30,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual));
...
INSERT INTO sprzedaze VALUES (1,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),1,1,1,1);
INSERT INTO sprzedaze VALUES (2,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),2,2,2,2);
INSERT INTO sprzedaze VALUES (3,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),3,3,3,3);
INSERT INTO sprzedaze VALUES (4,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),4,4,4,4);
INSERT INTO sprzedaze VALUES (5,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),5,5,5,5);
INSERT INTO sprzedaze VALUES (6,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),6,6,6,6);
INSERT INTO sprzedaze VALUES (7,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),7,7,7,7);
INSERT INTO sprzedaze VALUES (8,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),8,8,8,8);
INSERT INTO sprzedaze VALUES (9,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),9,9,9,9);
INSERT INTO sprzedaze VALUES (10,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),10,10,10,10);
INSERT INTO sprzedaze VALUES (11,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),11,11,11,11);
INSERT INTO sprzedaze VALUES (12,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),12,12,12,12);
INSERT INTO sprzedaze VALUES (13,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),13,13,13,13);
INSERT INTO sprzedaze VALUES (14,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),14,14,14,14);
INSERT INTO sprzedaze VALUES (15,(SELECT sysdate - round(dbms_random.value(1,7)) as "data" from dual),(SELECT sysdate + round(dbms_random.value(183,365)) as "data" from dual),15,15,15,15);
